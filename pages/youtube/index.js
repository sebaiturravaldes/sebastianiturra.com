...
export default function index () {
  return (
    <Layout>
      ...
      <p className="justify">Me compré este micrófono y comencé a grabar, previamente había realizado grabaciones, pero el audio se escuchaba pésimo,
      necesitaba mejorar al menos ese aspecto para poder grabar videos con mejor calidad en audio, luego vendría la etapa de mejorar la calidad de la grabación,
      así que mi primera inversión fue este micrófono.</p>
      <Image
